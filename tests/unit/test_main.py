...
from app.main import app, lifespan, local_gesture_models
...
def test_init_model_failure():
    ...
    with patch(
        "app.main.training_service.storage.load_model",
...
def test_predict_success():
    ...
    test_model = Mock()
    local_gesture_models["test_model"] = test_model
...
def test_predict_empty_data():
    ...
    request_data = {"modelId": "test_model", "rawData": []}
